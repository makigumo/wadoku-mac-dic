...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template name="seasonword_appendix">
        <d:entry id="wadoku_appendix_seasonwords" d:title="Anhang: Jahreszeitenwörter">
            <h1 xml:lang="de">Jahreszeitenwörter (<xsl:value-of select="count(wd:entry[.//wd:seasonword])"/>)</h1>
            <h1 xml:lang="ja">季語 (<xsl:value-of select="count(wd:entry[.//wd:seasonword])"/>)</h1>
            <dl>
                <dt xml:lang="de">Neujahr (<xsl:value-of select="count(wd:entry[.//wd:seasonword/@type='newyear'])"/>)</dt>
                <dt xml:lang="ja">新年 (<xsl:value-of select="count(wd:entry[.//wd:seasonword/@type='newyear'])"/>)</dt>
                ...
                <dt xml:lang="ja">春 (<xsl:value-of select="count(wd:entry[.//wd:seasonword/@type='spring'])"/>)</dt>
                ...
                <dt xml:lang="ja">夏 (<xsl:value-of select="count(wd:entry[.//wd:seasonword/@type='summer'])"/>)</dt>
                ...
                <dt xml:lang="ja">冬 (<xsl:value-of select="count(wd:entry[.//wd:seasonword/@type='winter'])"/>)</dt>
